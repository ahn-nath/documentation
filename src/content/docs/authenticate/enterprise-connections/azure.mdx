...
5. Select **Web** as the platform type for the redirect URI—not **SPA**.

   <Aside>

   Even if your own app is a single-page app, use **Web** for this redirect URI. The platform type describes who receives Microsoft's redirect—in this setup, that is Kinde's server, not your browser app. SPA platform settings use different OAuth rules and will cause login failures.
